...
tags = {
   names = { "term", "editor", "debug", "web", "files","media","graphic", "mail","im" },
   layout = { layouts[3], layouts[5], layouts[4], layouts[1], layouts[1], layouts[7], layouts[1],layouts[1], layouts[1] }
}
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Contro" }, "j", function () awful.screen.focus_relative( 1) end),
